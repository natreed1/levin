...
_BUILTIN_AGENTS: Tuple[Agent, ...] = (
    ...
    Agent(
        ...
        summary="Creates Teams, hires agents, drafts workflow loops; can also run approved automations.",
        how="Frontier model plans allowlisted setup tools (Hire/Harness APIs) + optional ritual runs; Room settings hold repo URLs and secrets.",
        prompt="",
        model="Settings active frontier profile",
        room_palette=False,
        stage="automate",
        skills=("setup", "automations", "rooms", "agents", "workflows"),
    ),
    Agent(
        id="orchestrator",
        name="Orchestrator",
